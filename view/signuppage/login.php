...
<!--Content-->
    ...
    <div class="form-group-container">
        ...
        <h2 style="text-align: center;">Login LuxStay</h2>
            ...
            <button type="submit" id = "btn-login" onClick = "login()"> Login </button>
            <div id="forgot">
                <a href="#" style="text-align: center; margin-top:5px;">Forgot passwod?</a>
            </div>
        </form>
    </div>
