    ...
    <div class="boxes">
        <?php
            foreach($attribute as $att) {
                ...
                echo '<div id="box"><a href="http://localhost/Project/detail/show/?id=' . $att->id . '"><img class ="image" src="../../view/image/hotel.jpg" alt="house" style="width:300px; height:200px"></a><a href="http://localhost/Project/detail/show/?id=' . $att->id . '">' . $att->name . '</a><p>' . $att->price . ' VND/Day</p></div>';
            }
            ?>
    </div>
