        ...
        <nav class="nav-bar">    
            ...
            <div class="search-bar">
                <form action="" method="POST" target="_blank"></form>
                    ...
                    <button id = "search-btn"><svg version="1.1" viewBox="0 0 15 15" class="svg-icon svg-fill" style="width: 20px; height: 20px; "><g stroke="#FFF" stroke-width="2" fill="none" fill-rule="evenodd"><path pid="0" d="M10 10l4 4"></path><circle pid="1" cx="6.5" cy="6.5" r="5.5"></circle></g></svg></button>
                </form>
            </div>
            </div>
            <div class="nav-right">
